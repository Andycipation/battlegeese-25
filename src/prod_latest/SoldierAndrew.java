...
public class SoldierAndrew extends Unit {
    /**
    ...
    static class ExploreStrategy extends SoldierStrategy {
        ...
        public void act() throws GameActionException {
            ...
            // System.out.println("Bytecodes used (2): " + (endBytecodes - startBytecodes));
            ...
            //     }
                if (!patternAppearsClear(srpCenter)) {
                    buildingSrp = false;
                    return;
                }
                if (rc.canSenseLocation(srpCenter) && rc.senseMapInfo(srpCenter).getMark().isAlly()) {
                    buildingSrp = false;
                    return;
                }
        ...
        @Override
        public String toString() {
            return "Explore " + target + (buildingRuin ? "Ruin" : (buildingSrp ? "Srp" : "None"));
        }
    }
